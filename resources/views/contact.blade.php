...
<body>
    ...
    <div>
        ...
        <div class="mt-4 space-y-3">
            ...
            <a href="#" class="flex items-center gap-3 text-gray-800 hover:text-gray-900 group">
                ...
                <span class="font-medium underline underline-offset-2 decoration-gray-400 group-hover:decoration-gray-800 transition">
                    Start a live chat
                </span>
            </a>

            <!-- Email -->
            <a href="mailto:hello@example.com" class="flex items-center gap-3 text-gray-800 hover:text-gray-900 group">
                <div class="flex-shrink-0">
                    <!-- PaperPlaneIcon -->
    ...
    <div>
        ...
        <div class="mt-4">
            <a href="tel:+15550000000" class="flex items-center gap-3 text-gray-800 hover:text-gray-900 group">
                <div class="flex-shrink-0">
                    <!-- PhoneIcon -->
                    <svg width="22" height="22"></svg>
                </div>
