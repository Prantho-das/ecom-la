                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex justify-end items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                        <div class="flex items-center space-x-2">
                            ...
                            <button  wire:click="changeShowMode('grid')" class="p-1 text-2xl {{ $showMode!='grid'?'text-green-600':'text-black' }}">
                            ...
                            <button wire:click="changeShowMode('list')"  class="p-1 text-2xl {{ $showMode=='grid'?'text-green-600':'text-black' }}">
                               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                    class="size-6">
