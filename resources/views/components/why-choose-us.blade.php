<section class="bg-white relative overflow-hidden">
    <div class="flex flex-wrap">
        ...
        <div class="w-full lg:w-3/5">
            <img src="/assets/images/why-choose-1.jpg" alt="Engineer with wind turbine models"
                class="w-full h-full object-cover" />
        </div>

        <!-- Right Image -->
        <div class="w-full lg:w-2/5">
            <img src="/assets/images/why-choose-2.jpg" alt="Engineer with wind turbine models"
                class="w-full h-full object-cover" />
        </div>
    </div>
